...
window.onload = function() {
    ...
    game = new Phaser.Game(gameOptions.gameWidth, windowHeight * gameOptions.gameWidth / windowWidth, Phaser.AUTO, 'game');
...
preloadGame.prototype = {
    preload: function(){
        ...
        game.load.image("floor", "ground.png");
        game.load.spritesheet("hero", "monkey.png", 32,32);
        game.load.image("ladder", "vine2.png");
...
playGame.prototype = {
    ...
    createMenu: function(){
        ...
        var tapText = game.add.bitmapText(game.width / 2, game.height - 120, "font", "Tap to jump", 45);
        tapText.anchor.set(0.5);
        this.menuGroup.add(tapText);
        var titleText = game.add.bitmapText(game.width / 2, game.height - 200, "font", "Monkey Jump", 90);
    ...
    addHero: function(){
        ...
        this.hero.animations.add('run',[0,1], 15, true);
